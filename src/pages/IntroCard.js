                ...
                <StyledIntroCard>
                    ...
                    <div className="card-body">
                        <p>
                            ...
                            I've gone from strictly front-end development to a
                            mix of front and back-end technologies, with a focus
                            on accessibilty for all users.
                        </p>
                        <p>
                            Read my{" "}
                            <StyledRouterLink to="/resume">
                                Resume
                            </StyledRouterLink>{" "}
